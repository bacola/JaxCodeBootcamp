...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="http://bacoladesign.webfactional.com/mysite/bistros.php">Bistros</a>
    </div>
    <ul class="nav navbar-nav">
      <li><a href="http://bacoladesign.webfactional.com/mysite/bistros.php">Home</a></li>
...
if(isset($_POST['addcategory'])) {
    ...
    $sql = "INSERT INTO menu (item_name)
...
$sql = "UPDATE menu SET item_name='{$_POST['item_name']}' WHERE item_id='{$_POST['item_id']}'";
...
$sql = "DELETE FROM menu WHERE item_id='{$_POST['item_id']}'";
...
<input type="text" name="item_name" value="<?  if(isset($_POST['updatecategory'])) { echo $_POST['item_name'];}?>">
